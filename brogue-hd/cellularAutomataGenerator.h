...
namespace brogueHd::backend
{
	...
	public:
		...
		void run(const gridRect& parentBoundary, const gridRect& relativeBoundary, gridCallback<bool> callback) override;
	...
	void cellularAutomataGenerator::run(const gridRect& parentBoundary, const gridRect& relativeBoundary, gridCallback<bool> callback)
	{
	...
	void cellularAutomataGenerator::runIteration(grid<bool>& resultGrid, const simpleList<cellularAutomataRule>* rules, bool resultPolarity)
	{
		int positiveCount = 0;
		int negativeCount = 0;
