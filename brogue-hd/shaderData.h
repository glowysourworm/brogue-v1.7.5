		...
		shaderData(shaderResource aresource, GLenum atype, const simpleString& asource)
		{
			...
			switch (this->resource)
			{
				...
				case shaderResource::brogueCellDisplayFrag:
					...
					this->uniforms1i.add(simpleUniform<int>("fontTexture", GL_SAMPLER_2D, 5));				// GLOBAL SETTING:  GL_TEXTURE5
				...
				case shaderResource::mixFrameTexturesFrag: 
					...
					this->uniforms1i.add(simpleUniform<int>("gameLogTexture", GL_SAMPLER_2D, 4));					// GLOBAL SETTING:  GL_TEXTURE4
