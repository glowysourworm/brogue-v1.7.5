...
namespace brogueHd::backend
{
                            ...
                            gridCallback<bool> callback)
    {
        ...
        while (history.count() > 0)
        {
            ...
            //
            simpleList<gridLocator> adjacentLocations = _mazeGrid->getCardinallyAdjacentElements(currentLocation.column, currentLocation.row)
                .where([] (const gridLocator& location) { return location != default_value::value<gridLocator>(); })    // !visited
                .where([&inclusionPredicate] (const gridLocator& location) { return inclusionPredicate(location.column, location.row, location); })
                .where([&visitedCells] (const gridLocator& location) { return !visitedCells.get(location.column, location.row); });
            ...
            else
            {
                ...
                //
                gridLocator nextLocation = getCardinalAdjacentCellWithBias(adjacentLocations, currentLocation, horizontalVerticalBias);
                                                               ...
                                                               double horizontalVerticalBias)
    {
        ...
        {
            simpleList<gridLocator> horizontalLocations = cardinalAdjacentLocations.where([&currentLocation](const gridLocator& location)
            {
        ...
        {
            simpleList<gridLocator> verticalLocations = cardinalAdjacentLocations.where([&currentLocation] (const gridLocator& location)
            {
                brogueCompass direction = gridMethods::getAdjacentDirection(currentLocation, location);
	                                              ...
	                                              const simpleList<gridLocator>& nextCell4WayNeighbors)
    {
        ...
        return nextCell4WayNeighbors.where([&currentLocation] (const gridLocator& location) { return location != currentLocation; })
									.count([] (const gridLocator& location) { return location != default_value::value<gridLocator>(); }) == 4;
    }
    ...
    bool mazeGenerator::fiveAdjacentWallsRule(const gridLocator& currentLocation, 
                                              ...
                                              const simpleList<gridLocator>& nextCell8WayNeighbors)
    {
        return nextCell8WayNeighbors.where([&currentLocation](const gridLocator& location) { return location != currentLocation; })
									.count([] (const gridLocator& location) { return location != default_value::value<gridLocator>(); }) >= 5;
    }
				                                          ...
				                                          const simpleList<gridLocator>& nextCell8WayNeighbors)
    {
        ...
        switch (direction)
        {
            case brogueCompass::N:
                return neighborWallDirections.count([] (brogueCompass x) { return (x == brogueCompass::W) || (x == brogueCompass::NW) || (x == brogueCompass::N) || (x == brogueCompass::NE) || (x == brogueCompass::E); }) >= 5;
            case brogueCompass::S:
                return neighborWallDirections.count([] (brogueCompass x) { return (x == brogueCompass::W) || (x == brogueCompass::SW) || (x == brogueCompass::S) || (x == brogueCompass::SE) || (x == brogueCompass::E); }) >= 5;
            case brogueCompass::E:
                return neighborWallDirections.count([] (brogueCompass x) { return (x == brogueCompass::N) || (x == brogueCompass::NE) || (x == brogueCompass::E) || (x == brogueCompass::SE) || (x == brogueCompass::S); }) >= 5;
            case brogueCompass::W:
                return neighborWallDirections.count([] (brogueCompass x) { return (x == brogueCompass::N) || (x == brogueCompass::NW) || (x == brogueCompass::W) || (x == brogueCompass::SW) || (x == brogueCompass::S); }) >= 5;
